...
const projectList = [
  {
    ...
    picture: store201,
    logos: [tailWindCSS, cSharp, mySQL, react],
  },
  {
    name: "TAGO",
    description:
      "TAGO is a horror game that blends survival, strategy, role-playing, and crafting elements, offering players a distinctive experience centered around carefully selected folklore creatures from the Philippines.",
    picture: tago,
